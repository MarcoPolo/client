...
export const localGetPendingPaymentsLocalRpcPromise = (params: LocalGetPendingPaymentsLocalRpcParam, waitingKey?: string): Promise<LocalGetPendingPaymentsLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.getPendingPaymentsLocal', params, callback: (error: RPCError, result: LocalGetPendingPaymentsLocalResult) => (error ? reject(error) : resolve(result)), waitingKey}))
export const localGetRequestDetailsLocalRpcPromise = (params: LocalGetRequestDetailsLocalRpcParam, waitingKey?: string): Promise<LocalGetRequestDetailsLocalResult> => new Promise((resolve, reject) => engine()._rpcOutgoing({method: 'stellar.1.local.getRequestDetailsLocal', params, callback: (error: RPCError, result: LocalGetRequestDetailsLocalResult) => (error ? reject(error) : resolve(result)), waitingKey}))
...
export type LocalCancelRequestLocalRpcParam = $ReadOnly<{reqID: KeybaseRequestID}>
...
export type LocalLookupCLILocalRpcParam = $ReadOnly<{name: String}>
...
export type NotifyPaymentNotificationRpcParam = $ReadOnly<{accountID: AccountID, paymentID: PaymentID}>
export type NotifyPaymentStatusNotificationRpcParam = $ReadOnly<{kbTxID: KeybaseTransactionID, txID: TransactionID}>
export type NotifyRequestStatusNotificationRpcParam = $ReadOnly<{reqID: KeybaseRequestID}>
...
export type RemoteCancelRequestRpcParam = $ReadOnly<{caller: Keybase1.UserVersion, reqID: KeybaseRequestID}>
...
type LocalLookupCLILocalResult = LookupResultCLILocal
type LocalMakeRequestCLILocalResult = KeybaseRequestID
